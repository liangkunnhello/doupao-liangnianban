...
describe('getGenerationStats', () => {
  ...
  it('groups matching tasks by workspace tab without double counting totals', () => {
    ...
    const stats = getGenerationStats([
      ...
      tab({ id: 'tab-a', name: '标签 A', tasks: [shared] }),
      tab({ id: 'tab-b', name: '标签 B', tasks: [failed] }),
    ], 'today', now)
