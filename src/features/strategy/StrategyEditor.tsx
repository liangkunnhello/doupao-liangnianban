...
export default function StrategyEditor({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col border-l border-gray-200/80 bg-gray-50/70 dark:border-white/[0.08] dark:bg-gray-950/70">
      ...
      {showSopPicker && <div className="fixed inset-0 z-[var(--ds-z-overlay)] flex items-center justify-center bg-black/40 p-4 animate-overlay-in motion-reduce:animate-none" role="dialog" aria-modal="true" aria-labelledby="sop-preset-dialog-title">
