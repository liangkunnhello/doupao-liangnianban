...
describe('agent draft lifecycle', () => {
  ...
  it('removes stale agent drafts except the last active conversation', () => {
    ...
    const activeDraft = { prompt: 'active', inputImages: [], maskDraft: null, maskEditorImageId: null, inputImageFolder: null, updatedAt: staleUpdatedAt }
    const staleDraft = { prompt: 'stale', inputImages: [], maskDraft: null, maskEditorImageId: null, inputImageFolder: null, updatedAt: staleUpdatedAt }
    const recentDraft = { prompt: 'recent', inputImages: [], maskDraft: null, maskEditorImageId: null, inputImageFolder: null, updatedAt: recentUpdatedAt }
