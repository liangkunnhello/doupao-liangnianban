...
describe('generated image filenames', () => {
  ...
  it('limits the prompt to 100 characters', () => {
    ...
    expect(base).toBe(`20260703-快手-${'y'.repeat(100)}-12`)
  })

  it('omits an empty prompt and falls back for an empty label', () => {
    expect(buildGeneratedImageFileNameBase({
      ...context,
      label: '  ',
      prompt: ' \n ',
    }, {
  ...
  it('continues after the largest matching sequence', () => {
    expect(findNextGeneratedImageSequence(
      ['20260703-快手-1.png', '20260703-快手-7.webp', '20260702-快手-9.png', 'other.txt'],
      context,
